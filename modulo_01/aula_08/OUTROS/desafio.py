...
def pode_formar_triangulo(a, b, c):
    # Verifica a regra da soma
    condicao_soma = a < b + c and b < a + c and c < a + b
    # Verifica a regra da diferença
...
while lado_a is None:
    lado_a = eh_numero_positivo(input("Digite o valor do lado A: "))

while lado_b is None:
    lado_b = eh_numero_positivo(input("Digite o valor do lado B: "))

while lado_c is None:
    lado_c = eh_numero_positivo(input("Digite o valor do lado C: "))

# Verificar se pode formar triângulo
if pode_formar_triangulo(lado_a, lado_b, lado_c):
